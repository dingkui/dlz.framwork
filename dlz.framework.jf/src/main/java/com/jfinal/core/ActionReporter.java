...
public class ActionReporter {
	private static final MyLogger log = MyLogger.getLogger(ActionReporter.class);
	...
	public static final void report(String target, Controller controller, Action action) {
		...
		sb.append(action.getControllerClass().getName()).append(".").append(action.getMethodName()).append(")\n");
