...
public class Record implements Serializable {
	 ...
	 * Get column of mysql type: varchar, char, enum, set, text, tinytext, mediumtext, longtext
	 */
	public String getStr(String column,String defualt) {
		Object o=getObj(column);
		if(o==null){
			return defualt;
		}
		return o.toString();
	 ...
	 * Get column of mysql type: int, integer, tinyint(n) n > 1, smallint, mediumint
	 */
	public Integer getInt(String column,Integer defualt) {
		Object o=getObj(column);
		if(o==null){
			return defualt;
		}
	 ...
	 * Get column of mysql type: bigint
	 */
	public Long getLong(String column,Long defualt) {
		Object o=getObj(column);
		if(o==null){
			return defualt;
		}
	...
	public <T> T asObj(Class<T> classs){
		Map<String, Object> map=getColumns();
		return JacksonUtil.coverObj(map, classs);
	}
	...
	public java.math.BigInteger getBigInteger(String column) {
		return (java.math.BigInteger)getObj(column);
	}
	...
	public java.util.Date getDate(String column) {
		return (java.util.Date)getObj(column);
	}
	...
	public java.sql.Time getTime(String column) {
		return (java.sql.Time)getObj(column);
	}
	...
	public java.sql.Timestamp getTimestamp(String column) {
		return (java.sql.Timestamp)getObj(column);
	}
	 ...
	 * Get column of mysql type: real, double
	 */
	public Double getDouble(String column,Double defualt) {
		Object o=getObj(column);
		if(o==null){
			return defualt;
		}
	 ...
	 * Get column of mysql type: float
	 */
	public Float getFloat(String column,Float defualt) {
		Object o=getObj(column);
		if(o==null){
			return defualt;
		}
	...
	public java.math.BigDecimal getBigDecimal(String column) {
		return (java.math.BigDecimal)getObj(column);
	}
	...
	public Number getNumber(String column) {
		return (Number)getObj(column);
	}
	
	private Object getObj(String column){
		Map<String, Object> map=getColumns();
		Object o=map.get(column);
		if(o==null){
			o=map.get(column.toLowerCase());
		}
		return o;
	}
