...
public class MyLogger2 extends Log4JLogger  {
	static{
		System.setProperty("org.apache.commons.logging.Log", MyLogger2.class.getName());
	}
	 @SuppressWarnings("rawtypes")
	public static synchronized MyLogger2 getLogger(Class claz) {  
	    	return (MyLogger2)LogFactory.getLog(claz);  
	 } 
    ...
    private static final String FQCN = MyLogger2.class.getName();
     ...
     */
    public MyLogger2(Logger logger) {
        if (logger == null) {
