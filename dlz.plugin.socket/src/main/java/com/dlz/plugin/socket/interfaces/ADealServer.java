...
//
//public abstract class ADealServer  extends Thread{
//
//	private static MyLogger logger = MyLogger.getLogger(ADealServer.class);
//
...
//	 * @throws IOException
//	 */
//	public ADealServer(int serverPort,int poolSize, IDealService dealService,ASocketIO sio) throws IOException {
