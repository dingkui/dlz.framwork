...
import com.dlz.commbiz.notice.sms.sdk.Mo;
import com.dlz.commbiz.notice.sms.sdk.SDKServiceBindingStub;
import com.dlz.commbiz.notice.sms.sdk.SDKServiceLocator;
import com.dlz.commbiz.notice.sms.sdk.StatusReport;
...
public class Client {
	...
	public int sendSMS( String[] mobiles, String smsContent, String addSerial,int smsPriority)
		...
		logger.debug("sms：["+value+"]["+mobiles+"]["+smsContent+"]");
		return value;
	}
