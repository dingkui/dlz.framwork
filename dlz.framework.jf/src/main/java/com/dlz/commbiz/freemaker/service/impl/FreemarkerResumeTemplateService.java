 ...
 */  
@Service
public class FreemarkerResumeTemplateService implements TemplateService {  
    /** 
     * 邮件模板的存放位置 
     */  
    private static final String TEMPLATE_PATH = "/resume/";  
    /** 
     * 启动模板缓存 
     */  
    ...
    private Configuration configuration;  
        ...
        configuration.setTemplateLoader(new ClassTemplateLoader(FreemarkerResumeTemplateService.class, TEMPLATE_PATH));  
        configuration.setEncoding(Locale.getDefault(), "UTF-8");  
        configuration.setDateFormat("yyyy-MM-dd HH:mm:ss");  
    }
		public FreemarkerResumeTemplateService(){
			init();
		}
    ...
    public void getOutputStream(String templateId, Map<Object, Object> parameters,OutputStream fos) {  
    	...
    	try {  
    		...
    		template.process(parameters, oWriter);  
    	} catch (Exception e) {  
    		throw new RuntimeException(e);  
    	}  
    }  
