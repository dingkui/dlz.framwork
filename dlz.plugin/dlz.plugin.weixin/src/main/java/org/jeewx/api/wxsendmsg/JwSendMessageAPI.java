...
//				JSONObject result = WxstoreUtils.uploadMediaFile(requestUrl, file, contentType);
     ...
     * @throws WexinReqException
     */
	public static void modelMessage(String accesstoken, String touser,JSONObject obj) throws WexinReqException {
     ...
     * @throws WexinReqException
     */
	public static void xcxModelMessage(String accesstoken, String touser,JSONObject obj) throws WexinReqException {
