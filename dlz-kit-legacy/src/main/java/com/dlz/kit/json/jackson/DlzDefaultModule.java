 ...
 * @since 2023
 */
public class DlzDefaultModule extends SimpleModule {
	/**
	 * 单例实例
	 */
	public static final DlzDefaultModule INSTANCE = new DlzDefaultModule();

	/**
	 * 私有构造函数，初始化时间类型序列化器和反序列化器
	 */
	private DlzDefaultModule() {
		super();
...
//        this.addDeserializer(JSONMap.class, new JSONMapDeserializer());
	}
