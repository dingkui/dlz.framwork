...
public class ConfigUtil {
	...
	public static void loadProperty() {
		try {
			...
			props.clear();
			props.load(file);
			ICommService baseSetService = SpringHolder.getBean(ICommService.class);
			...
			for (ResultMap subject : subjectList) {
				if(!props.containsKey(subject.getStr("baseCode"))){
					props.put(subject.getStr("baseCode"), subject.getStr("baseValue",""));
				}
			}
		} catch (Exception e) {
