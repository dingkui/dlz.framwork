...
//		return toInt((Object)str, checked);
//	}
//	/**
...
//	 * @return
//	 */
//	public static int toInt(Object str, Integer defaultValue) {
//		if (isEmpty(str)) {
//			return defaultValue;
//		}
//		try {
...
//		return toInt((Object)str, defaultValue);
//	}
//	
//	/**
//	 * 将字符型转为Int型
...
//		return EncryptUtil.md5(formatter.format(now) + random.nextDouble());
//	}
//
//	/**
//	 * 将中文汉字转成UTF8编码
