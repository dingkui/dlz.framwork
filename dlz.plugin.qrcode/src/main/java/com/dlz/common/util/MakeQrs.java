...
public class MakeQrs {
	private static MyLogger logger =  MyLogger.getLogger(MakeQrs.class);
	...
	String path="";
//	String glUrl="http://h.shunliannet.com/sb.do?QRCode=03000581307&custom=gls_";
	...
	static int x_add=596;
	static int y_add=644;
	...
	public void addQrs1(Graphics gs,int row,int col,long id,String glUrl,String sn,String Url) throws Exception {
		try {
			int textX1=x16+x_add*col*2+col;
			int texty1=y570+y_add*row;
			...
			for(int col=0;col<4;col++){
				for(int row=0;row<5;row++){
					...
					if("2".equals(mkmethod)){
						...
						String glUrls=AccessToken.getQrcodeUrl("wx2c47c65ea92ede0c", "a8f52ad591654895f02c96e059ffefc8","hotel_"+sn,false);
