...
public class HttpUtil {
	...
	public enum HttpUtilEnum{
		...
		public String send(String url, HttpEntity para, Map<String, String> headers) {
			return (String) doHttp(getRequest(url), url, null, para, headers, CHARSET_UTF8, CHARSET_UTF8, true, 1, null);
		}
...
//			}
	...
	public static void main(String[] args) {
		JSONMap m=new JSONMap("{\"pid\":\"100000936988\",\"storeId\":2128095988,\"wid\":-16011988597891974,\"refer\":\"goodsdetail\",\"source\":2,\"barginGrouponVersion\":2,\"goodsId\":1259581420188}");
		StringEntity stringEntity = new StringEntity((m.toString()),  "utf-8");

		Map<String,String> m2=new HashMap<>();
		m2.put("Cookie","rprm_cuid=11716400839ki896fgvg; Hm_lvt_c1df8c79ab44a42f4e36f5ae9b1f6d48=1601171640; isout=1; authDataType=saas; saasRedirectOnEnter=1; Hm_lpvt_c1df8c79ab44a42f4e36f5ae9b1f6d48=1601198494; saasAuthData=5007fd6df609f11742d391c3c7648a16d97c6f2b234e5a9099a9b6671f9cfa95; saas.express.session=s%3AXU2rh9IiSIw6n44UiHUAORWu8DlQ1CDk.AS8tKxXarOw8ZgIQSsJTMcEfu958ia%2FY5baqfi85aj0; pluto=XU2rh9IiSIw6n44UiHUAORWu8DlQ1CDk; rprm_appShowId2=-kfm40y43p8s4v792lik");
		m2.put("Content-Type","application/json; charset=utf-8");

		String url="https://100000936988.retail.n.weimob.com/api3/ec/navigation/goods/getGoodsDescriptionArea";

		String send = HttpUtilEnum.POST.send(url, stringEntity,m2);
		JSONMap r=new JSONMap(send);
		System.out.println("----------------------------");
		System.out.println(r.get("data"));
		System.out.println(r.at("data.pageModules",String.class));
		System.out.println(r.at("data.pageModules[0]",String.class));
		System.out.println(r.at("data.pageModules[0].data.goodsDescription",String.class));
	}
}
