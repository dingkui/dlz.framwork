...
public class MebLoginInfo extends BaseModel {
    private static final long serialVersionUID = 1L;

    public String tableName = "S_MEB_LOGIN_INFO";

    public String tableColums = "ML_ID,ML_MID,ML_TIME,ML_IP,ML_POINT,ML_ARER,ML_TYPE,ML_CHANEL";

    /**
     * S_MEB_LOGIN_INFO.ML_ID
     * 登陆ID
     */
    private Long mlId;

    /**
     * S_MEB_LOGIN_INFO.ML_MID
     * 用户ID
     */
    private Long mlMid;

    /**
     * S_MEB_LOGIN_INFO.ML_TIME
     * 登录时间
     */
    private Date mlTime;

    /**
     * S_MEB_LOGIN_INFO.ML_IP
     * 登录IP
     */
    private String mlIp;

    /**
     * S_MEB_LOGIN_INFO.ML_POINT
     * 登录坐标地点
     */
    private String mlPoint;

    /**
     * S_MEB_LOGIN_INFO.ML_ARER
     * 地点
     */
    private String mlArer;

    /**
     * S_MEB_LOGIN_INFO.ML_TYPE
     * 登录方式 1:注册登录 2:用户名密码登录 3:QQ绑定登录 4:微信绑定登录 5:自动登录 6:短信登录 7:找回密码
     */
    private Long mlType;

    /**
     * S_MEB_LOGIN_INFO.ML_CHANEL
    ...
    /**
     * @param mlId the value for S_MEB_LOGIN_INFO.ML_ID
     * 登陆ID
     */
    ...
    /**
     * @param mlMid the value for S_MEB_LOGIN_INFO.ML_MID
     * 用户ID
     */
    ...
    /**
     * @param mlTime the value for S_MEB_LOGIN_INFO.ML_TIME
     * 登录时间
     */
    ...
    /**
     * @param mlIp the value for S_MEB_LOGIN_INFO.ML_IP
     * 登录IP
     */
    ...
    /**
     * @param mlPoint the value for S_MEB_LOGIN_INFO.ML_POINT
     * 登录坐标地点
     */
    ...
    /**
     * @param mlArer the value for S_MEB_LOGIN_INFO.ML_ARER
     * 地点
     */
    ...
    /**
     * @param mlType the value for S_MEB_LOGIN_INFO.ML_TYPE
     * 登录方式 1:注册登录 2:用户名密码登录 3:QQ绑定登录 4:微信绑定登录 5:自动登录 6:短信登录 7:找回密码
     */
    ...
    /**
     * @param mlChanel the value for S_MEB_LOGIN_INFO.ML_CHANEL
     * 渠道 1:PC 2:安卓 3:Iphone 4:IPAD 5:微信 6:手机站
     */
