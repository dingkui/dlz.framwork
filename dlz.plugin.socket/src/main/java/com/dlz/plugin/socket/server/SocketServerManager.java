...
public class SocketServerManager {
	...
	public static void startServer(String serverName,int port,int poolsize, IDealService socketService,ISocketIO socketReader) throws IOException {
		if(serverName==null){
...
//	public static void startServerPool(String serverName,int port,int poolsize, IDealService socketService,ISocketIO socketReader) throws IOException {
//		if(serverName==null){
//			logger.error("服务器启动失败，无serverName");
//			return;
//		}
