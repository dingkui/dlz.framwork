...
public class BaseSet extends BaseModel {
	void doNothing(){new java.util.ArrayList<>().forEach(a->{});}
    private static final long serialVersionUID = 1L;

    @JsonIgnore
    public String tableName = "T_B_BASE_SET";

    @JsonIgnore
    public String tableColums = "BASE_CODE,BASE_VALUE,STATUS,CREATE_TIME,CREATE_ID,CREATE_NAME,REMARKS,UPDATE_TIME,UPDATE_ID,UPDATE_NAME";
